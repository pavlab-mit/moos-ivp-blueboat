...
void showExampleConfigAndExit()
{
  ...
  blk("                                                                ");
  blk("  // GPS antenna lever arm, body frame (m). The antenna is      ");
  blk("  // rarely at the hull reference point; under rotation the     ");
  blk("  // uncorrected filter reports antenna-frame position and      ");
  blk("  // phantom speed (v_ant = v_hull + omega x r). 0,0 disables.  ");
  blk("  gps_lever_x = 0.0       // Antenna forward of hull ref (m)    ");
  blk("  gps_lever_y = 0.0       // Antenna starboard of hull ref (m)  ");
  blk("                                                                ");
...
void showInterfaceAndExit()
{
  ...
  blk("                     CCW-positive about +z up (drives heading   ");
  blk("                     prediction and the lever-arm correction)   ");
  blk("                                                                ");
  ...
  blk("  NAV_SPEED        - Filtered speed (m/s, unsigned magnitude)   ");
  blk("  NAV_COG          - Filtered course over ground (deg, compass) ");
  blk("  NAV_SURGE        - Signed hull-frame surge (m/s): positive    ");
  blk("                     ahead, negative astern. Speed-loop feedback");
  blk("                     (pBBPID nav_speed_var) should use this.    ");
  blk("  NAV_SWAY         - Signed hull-frame sway (m/s, starboard+)   ");
